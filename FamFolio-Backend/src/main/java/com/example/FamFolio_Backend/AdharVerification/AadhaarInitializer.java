    ...
    public CommandLineRunner initializeAadhaarRecords(AadhaarRepository aadhaarRepository) {
        return args -> {
            ...
            List<AadhaarRecord> mockAadhaarRecords = List.of(
                    ...
                    new AadhaarRecord("789056789123", "Aditi Choudhary", LocalDate.of(1999, 4, 25), "Female", "yashgokulgandhi6@gmail.com", "914321098765"),
                    new AadhaarRecord("890167891234", "Reyansh Kumar", LocalDate.of(2002, 9, 12), "Male", "yashgokulgandhi6@gmail.com", "913210987654"),
                    ...
                    new AadhaarRecord("123490123456", "Kavya Iyer", LocalDate.of(1983, 6, 21), "Female", "yashgokulgandhi6@gmail.com", "910987654321")
            );
